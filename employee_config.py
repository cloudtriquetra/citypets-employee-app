...
EMPLOYEES = {
    "***REMOVED***": {
        ...
        "holiday_rate_walk": 30,       # Holiday rate for walk work  
        "holiday_rate_overnight": 100  # Holiday rate for overnight work
    },
    "***REMOVED***": {
        "hotel": 25,
        "walk": 25,
...
JOB_TYPE_RESTRICTIONS = {
    "training": ["***REMOVED***"],  # Only Weronika can do training by default
    # "management": ["***REMOVED***", "***REMOVED***"],  # Example: Only specific employees can do management
